				...
				<Stack direction={'row'} spacing={1} justifyContent="center">
					<Stack className="historydetail-container">
						...
						<Grid container justifyContent="center" paddingLeft={3} paddingRight={3} marginBottom={3}>
							<Grid item xs={3}>
								<Typography className="historydetail-container__spectext" sx={{ fontWeight: 'bold' }}>
									ĐẶC ĐIỂM
								</Typography>
							</Grid>
						...
						<Grid container justifyContent="center" paddingLeft={3} paddingRight={3} marginBottom={3}>
							...
							<Grid item xs={9} spacing={2}>
								...
								<Typography className="historydetail-container__text">Và chọn 1 trong 2 hình thức</Typography>
								<Typography className="historydetail-container__text">
									<AssignmentIndOutlinedIcon fontSize="medium" className="paymenthistory-container__icon" /> Passport hoặc Hộ
									khẩu hoặc KT3 (giữ lại)
								</Typography>
								<Typography className="historydetail-container__text">
									<RecentActorsOutlinedIcon fontSize="medium" className="paymenthistory-container__icon" /> Căn cước công dân gắn
									chip (đối chiếu)
								</Typography>
							</Grid>
						</Grid>
					...
					<Stack className="paymenthistory-container" padding={3}>
						...
						<Typography
							className="paymenthistory-container__title"
						...
						<Stack
							className="paymenthistory-container__pricebox"
							direction="row"
